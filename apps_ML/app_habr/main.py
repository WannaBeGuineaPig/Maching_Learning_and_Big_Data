...
# model = load('best_model_habr.joblib')
# vectorizer = load('vectorizer_habr.joblib')

with open('best_model_habr.pkl', 'rb') as file:
    model = pickle.load(file)

with open('vectorizer_habr.pkl', 'rb') as file:
